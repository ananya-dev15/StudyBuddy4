          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
            <div>
              ...
              <p style={{ margin: "2px 0 0 0", fontSize: "0.85rem", color: "#6b7280" }}>
                Click below to view all saved study video cards and daily logs
              </p>
            </div>
            <button
      ...
      {showWatchHistoryModal && (
        ...
        >
          ...
          >
            ...
            >
              <div>
                <h3 style={{ margin: "0 0 2px 0", fontSize: "1.2rem", fontWeight: "700" }}>
                  📜 Study Video Watch History
                </h3>
                <p style={{ margin: 0, fontSize: "0.82rem", opacity: 0.9 }}>
                  All saved video sessions & study stats
                </p>
              </div>
              <button
                onClick={() => setShowWatchHistoryModal(false)}
                ...
                if (uniqueCards.length === 0) {
                  return (
                    <div style={{ padding: "40px 20px", textAlign: "center" }}>
                      <p style={{ color: "#9ca3af", fontSize: "1rem", margin: 0 }}>No study video cards found.</p>
                    </div>
                  );
                }
